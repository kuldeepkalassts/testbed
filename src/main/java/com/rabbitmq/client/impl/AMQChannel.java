...
public abstract class AMQChannel extends ShutdownNotifierComponent {
	...
	private static final long coolDownTime = System.currentTimeMillis();
	...
	public static boolean doNotSendMessage = true;
    ...
    private AMQCommand privateRpc(Method m)
        throws IOException, ShutdownSignalException
    {
    	if(doNotSendMessage && m.protocolMethodName().toLowerCase().contains("commit")) {
    		throw new IOException("custm excp");
    	}
        ...
        if(_rpcTimeout == NO_RPC_TIMEOUT) {
            ...
            try {
            	...
            	System.out.println("[UKG_TEST]  Creating timeout error ");
